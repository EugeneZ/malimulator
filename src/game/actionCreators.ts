...
export const runFlow = createStandardAction('flow/run')<
  Job,
  { [key: string]: any }
>();
...
export const receivedChoices = createStandardAction('choices/received')<
  ReceivedChoicesParams
>();

export const inputEntered = createStandardAction('input/entered')<string>();
export const receivedSkills = createStandardAction('skills/received')<
...
export const recievedCodeTask = createStandardAction('code/received')<
  CodeTaskParams
>();
export const completedCodeTask = createStandardAction('code/completed')<
  CodeTaskParams
>();
